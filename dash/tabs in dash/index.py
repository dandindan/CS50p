...
app.layout = html.Div([
    html.Div([
        html.Div([
            ...
            html.Div([
                html.H5('World Countries Information 1952 - 2007',
...
def update_graph(select_continent, select_countries):
    data1 = data.groupby(['country', 'year', 'continent'])[
        ['pop', 'lifeExp', 'gdpPercap']].sum().reset_index()
    data2 = data1[(data1['continent'] == select_continent)
                  & (data1['country'] == select_countries)]
    ...
    return {
        'data': [
            go.Scatter(
                ...
                hoverinfo='text',
                hovertext='<b>Country</b>: ' + data2['country'].astype(str) + '<br>' +
                '<b>Year</b>: ' + data2['year'].astype(str) + '<br>' +
                '<b>Continent</b>: ' + data2['continent'].astype(str) + '<br>' +
                '<b>Life Expectancy</b>: ' +
                [f'{x:,.3f}' for x in data2['lifeExp']] + '<br>'
    ...
    return {
        'data': [
            go.Scatter(
                ...
                '<b>Continent</b>: ' + data2['continent'].astype(str) + '<br>' +
                '<b>gdpPercap</b>: ' +
                [f'{x:,.6f}' for x in data2['gdpPercap']] + '<br>'
...
def update_graph(select_continent):
    data1 = data.groupby(['country', 'continent'])[
        ['pop', 'lifeExp', 'gdpPercap']].mean().reset_index()
    data2 = data1[(data1['continent'] == select_continent)
                  ].nlargest(10, columns=['lifeExp'])
    ...
    return {
        'data': [
            go.Bar(
                ...
                '<b>Continent</b>: ' + data2['continent'].astype(str) + '<br>' +
                '<b>gdpPercap</b>: ' +
                [f'{x:,.3f}' for x in data2['gdpPercap']] + '<br>'
