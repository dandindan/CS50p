...
terr2 = pd.read_csv(
    'dash/dash two dropdown/modified_globalterrorismdb_0718dist.csv')

location1 = terr2[['country_txt', 'latitude', 'longitude']]
list_locations = location1.set_index(
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([
                html.H3('Global Terrorism Database', style={
    ...
    html.Div([
        html.Div([
            ...
            html.P('Select Year:', className='fix_label', style={
...
def update_graph(w_countries, w_countries1, select_years):
    terr3 = terr2.groupby(['region_txt', 'country_txt', 'provstate', 'city',
                          'iyear', 'latitude', 'longitude'])[['nkill', 'nwound']].sum().reset_index()
    ...
    return {
        'data': [go.Scattermapbox(
            ...
            hoverinfo='text',
            hovertext='<b>Region</b>: ' + terr4['region_txt'].astype(str) + '<br>' +
...
def update_graph(w_countries, w_countries1, select_years):
    ...
    terr7 = terr2.groupby(['region_txt', 'country_txt', 'iyear'])[
        ['attacktype1', 'nwound']].sum().reset_index()
    ...
    return {
        'data': [go.Scatter(x=terr6['iyear'],
                            ...
                            hoverinfo='text',
                            hovertext='<b>Region</b>: ' + terr6['region_txt'].astype(str) + '<br>' +
                 ...
                 go.Bar(
                     ...
                     hoverinfo='text',
                     hovertext='<b>Region</b>: ' + terr8['region_txt'].astype(str) + '<br>' +
                     '<b>Country</b>: ' + terr8['country_txt'].astype(str) + '<br>' +
                     '<b>Year</b>: ' + terr8['iyear'].astype(str) + '<br>' +
                     '<b>Attack</b>: ' +
            [f'{x:,.0f}' for x in terr8['attacktype1']] + '<br>'
        ),
            ...
            '<b>Year</b>: ' + terr8['iyear'].astype(str) + '<br>' +
            '<b>Wounded</b>: ' +
            [f'{x:,.0f}' for x in terr8['nwound']] + '<br>'
        )],
